...
public class javafile extends Activity implements OnClickListener
{
...
class ResultDelegate implements PayPalResultDelegate, Serializable {
	...
	public void onPaymentSucceeded(String payKey, String paymentStatus) {
		javafile.resultTitle = "SUCCESS";
		javafile.resultInfo = "You have successfully completed your transaction.";
		javafile.resultExtra = "Key: " + payKey;
	}
	...
	{
		javafile.resultTitle = "FAILURE";
		javafile.resultInfo = errorMessage;
		javafile.resultExtra = "Error ID: " + errorID + "\nCorrelation ID: "
				+ correlationID + "\nPay Key: " + payKey;
	}
	...
	public void onPaymentCanceled(String paymentStatus) {
		javafile.resultTitle = "CANCELED";
		javafile.resultInfo = "The transaction has been cancelled.";
		javafile.resultExtra = "";
	}
}